...
public class HttpUrls {
    ...
    public static final String NERVOS_TRANSACTION_URL = APPCHAIN_SERVER_URL + "/api/transactions?account=";
    public static final String NERVOS_TRANSACTION_URL_STAGING = APPCHAIN_SERVER_URL_STAGING + "/api/transactions?account=";
