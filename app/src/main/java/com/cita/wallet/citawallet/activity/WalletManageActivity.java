...
import com.cita.wallet.citawallet.item.WalletItem;
...
public class WalletManageActivity extends AppCompatActivity {
    ...
    private void initData() {
        walletItemList.add(new WalletItem("钱包A", "0x123456698734353434", "CIT"));
        walletItemList.add(new WalletItem("钱包B", "0x123456698734353434", "ETH"));
        walletItemList.add(new WalletItem("钱包C", "0x123456698734353434", "BTC"));
        walletItemList.add(new WalletItem("钱包D", "0x123456698734353434", "EOS"));
        walletItemList.add(new WalletItem("钱包E", "0x123456698734353434", "KEY"));
    }
    ...
    class WalletAdapter extends RecyclerView.Adapter<WalletAdapter.WalletViewHolder> {
        ...
        public void onBindViewHolder(@NonNull WalletAdapter.WalletViewHolder holder, int position) {
            ...
            holder.walletAddressText.setText(walletItemList.get(position).address);
            holder.tokenNameAmountText.setText(walletItemList.get(position).tokenName);
