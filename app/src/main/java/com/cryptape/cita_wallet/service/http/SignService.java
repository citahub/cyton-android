...
public class SignService {
    ...
    public static Observable<String> signEthMessage(Context context, String message, String password) {
        return Observable.fromCallable(new Callable<String>() {
            ...
            public String call() throws Exception {
                ...
                Sign.SignatureData signatureData = Sign.signMessage(message.getBytes(), ECKeyPair.create(Numeric.toBigInt(privateKey)));
                return getSignature(signatureData);
            }
        }).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }

    public static Observable<String> signPersonalMessage(Context context, String message, String password) {
        return Observable.fromCallable(new Callable<String>() {
            @Override
            public String call() throws Exception {
                Wallet wallet = DBWalletUtil.getCurrentWallet(context);
                ...
                Sign.SignatureData signatureData = Sign.signMessage(unSignData, ECKeyPair.create(Numeric.toBigInt(privateKey)));
    ...
    public static Observable<String> signCITAMessage(Context context, String message, String password) {
        return Observable.fromCallable(new Callable<String>() {
            @Override
            public String call() throws Exception {
                Wallet wallet = DBWalletUtil.getCurrentWallet(context);
                String privateKey = WalletEntity.fromKeyStore(password, wallet.keystore).getPrivateKey();
                com.cryptape.cita.crypto.Sign.SignatureData signatureData = com.cryptape.cita.crypto.Sign.signMessage(message.getBytes(), com.cryptape.cita.crypto.ECKeyPair
                        .create(Numeric.toBigInt(privateKey)));
